// <copyright file="UnauthorizedException.cs" company="slskdN">
...
namespace slskd
{
    ...
    public class UnauthorizedException : SlskdException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="UnauthorizedException"/> class with a specified error message and a
